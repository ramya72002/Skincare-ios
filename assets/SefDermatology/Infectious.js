...
class Infectious extends Component {
  constructor(props) {
    ...
    this.subtitleImages = [
      require('./banners/infectious/image1.png'),
      require('./banners/infectious/image4.png'),
      require('./banners/infectious/image7.png'),
      require('./banners/infectious/image10.png'), 
      require('./banners/infectious/image13.png'),
      require('./banners/infectious/image16.png'),
      require('./banners/infectious/image19.png'),
      require('./banners/infectious/image22.png'),
      require('./banners/infectious/image15.png'),
      require('./images/image.png'),
    ];
  }

  componentDidMount() {
    this.fetchInfectious();
  }
  ...
  fetchInfectious = () => {
    ...
    fetch('https://backen-skin-care-app.vercel.app/infectioust', {
      method: 'POST',
      headers: {
      ...
      .then((responseJson) => {
        this.setState({
          translatedInfectious: responseJson.tips,
          loading: false,
        });
      })
      .catch((error) => {
  ...
  renderContent = (contentArray) => {
    ...
    content.push(
      <View key="additional-resource" style={styles.contentBlock}>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://www.mayoclinic.org/diseases-conditions/infectious-diseases/symptoms-causes/syc-20351173')}>
          <Text style={styles.link}> &#8226; https://www.mayoclinic.org/diseases-conditions/infectious-diseases/symptoms-causes/syc-20351173</Text>
        </TouchableOpacity>
      </View>
    );
  ...
  render() {
    const { translatedInfectious, loading, error } = this.state;
    return (
        ...
        <View style={styles.scrollContainer}>
          {loading ? (
            ...
            <ScrollView contentContainerStyle={styles.scrollView}>
              {this.renderContent(translatedInfectious)}
            </ScrollView>
          )}
